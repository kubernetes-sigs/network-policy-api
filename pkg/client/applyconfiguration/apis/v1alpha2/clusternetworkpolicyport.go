...
type ClusterNetworkPolicyPortApplyConfiguration struct {
	...
	Range  *ClusterNetworkPolicyMatchPortRangeApplyConfiguration `json:"range,omitempty"`
}
...
func (b *ClusterNetworkPolicyPortApplyConfiguration) WithRange(value *ClusterNetworkPolicyMatchPortRangeApplyConfiguration) *ClusterNetworkPolicyPortApplyConfiguration {
	b.Range = value
	return b
}
