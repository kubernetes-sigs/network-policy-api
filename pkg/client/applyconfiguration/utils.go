...
func ForKind(kind schema.GroupVersionKind) interface{} {
	...
	case v1alpha2.SchemeGroupVersion.WithKind("ClusterNetworkPolicyProtocolNamedPort"):
		return &apisv1alpha2.ClusterNetworkPolicyProtocolNamedPortApplyConfiguration{}
