...
type BaselineAdminNetworkPoliciesGetter interface {
	BaselineAdminNetworkPolicies(namespace string) BaselineAdminNetworkPolicyInterface
}
...
func newBaselineAdminNetworkPolicies(c *PolicyV1alpha1Client, namespace string) *baselineAdminNetworkPolicies {
