...
func (c *PolicyV1alpha1Client) AdminNetworkPolicies(namespace string) AdminNetworkPolicyInterface {
	return newAdminNetworkPolicies(c, namespace)
}

func (c *PolicyV1alpha1Client) BaselineAdminNetworkPolicies(namespace string) BaselineAdminNetworkPolicyInterface {
	return newBaselineAdminNetworkPolicies(c, namespace)
}
