...
.PHONY: conformance
conformance:
	go test ${GO_TEST_FLAGS} -v ./conformance -run TestConformance -timeout 20m -args ${CONFORMANCE_FLAGS}

.PHONY: conformance-profiles
conformance-profiles:
	go test ${GO_TEST_FLAGS} -v ./conformance -run TestConformanceProfiles -timeout 20m -args ${CONFORMANCE_FLAGS}

.PHONY: conformance-profiles-default
conformance-profiles-default:
	go test ${GO_TEST_FLAGS} -v ./conformance -run TestConformanceProfiles -timeout 20m -args --conformance-profiles=AdminNetworkPolicy,BaselineAdminNetworkPolicy
