...
func init() {
	ConformanceTests = append(ConformanceTests,
		CNPBaselineTierEgressTCP,
	)
}

var CNPBaselineTierEgressTCP = suite.ConformanceTest{
	ShortName:   "CNPBaselineTierEgressTCP",
	Description: "Tests support for egress traffic (TCP protocol) using baseline cluster network policy API based on a server and client model",
	Features: []suite.SupportedFeature{
		suite.SupportClusterNetworkPolicy,
	},
	Manifests: []string{"base/baseline_tier/standard-egress-tcp-rules.yaml"},
