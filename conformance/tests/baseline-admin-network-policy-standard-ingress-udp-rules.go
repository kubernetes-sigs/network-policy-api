...
func init() {
	ConformanceTests = append(ConformanceTests,
		CNPBaselineTierIngressUDP,
	)
}

var CNPBaselineTierIngressUDP = suite.ConformanceTest{
	ShortName:   "CNPBaselineTierIngressUDP",
	Description: "Tests support for ingress traffic (UDP protocol) using baseline cluster network policy API based on a server and client model",
	Features: []suite.SupportedFeature{
		suite.SupportClusterNetworkPolicy,
	},
	Manifests: []string{"base/baseline_tier/standard-ingress-udp-rules.yaml"},
