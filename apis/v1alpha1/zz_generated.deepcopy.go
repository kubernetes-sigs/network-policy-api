...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodPeer) DeepCopyInto(out *PodPeer) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodPeer.
func (in *PodPeer) DeepCopy() *PodPeer {
	if in == nil {
		return nil
	}
	out := new(PodPeer)
