...
func (in *ClusterNetworkPolicyProtocol) DeepCopyInto(out *ClusterNetworkPolicyProtocol) {
	*out = *in
	...
	if in.DestinationNamedPort != nil {
		...
		*out = new(ClusterNetworkPolicyProtocolNamedPort)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterNetworkPolicyProtocolNamedPort) DeepCopyInto(out *ClusterNetworkPolicyProtocolNamedPort) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterNetworkPolicyProtocolNamedPort.
func (in *ClusterNetworkPolicyProtocolNamedPort) DeepCopy() *ClusterNetworkPolicyProtocolNamedPort {
	if in == nil {
		return nil
	}
	out := new(ClusterNetworkPolicyProtocolNamedPort)
